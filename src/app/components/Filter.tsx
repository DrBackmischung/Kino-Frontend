...
import {
    ...
    FormControlLabel,
    FormGroup, FormLabel, Radio, RadioGroup, Slider,
...
function Filter(props: any) {
    ...
    const {moviesData, selectedGenre} = props;
    ...
    const uniqueGenresArray = genresStringArray.filter((value: any, index: any, self: any) => self.indexOf(value) === index);
