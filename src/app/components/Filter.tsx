...
function Filter(props: any) {
    ...
    const genresString = originalGenresArray.toString();
    const genresStingNoWhitespaces = genresString.replace(/\s/g, "");
    const genresStringArray = genresStingNoWhitespaces.split(",");
