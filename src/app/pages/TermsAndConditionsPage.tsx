        ...
        <Container className="wholeContainer" sx={{
            ...
            <Container className="AGBContainer">
                <Box>
                    ...
                    <p/>
                    <p>(1) Die nachfolgenden Allgemeinen Geschäftsbedingungen gelten für alle Lieferungen zwischen uns
                    ...
                    <h2>§4 Lieferung</h2>
                    <p/>
                    <p>(1) Sofern wir dies in der Produktbeschreibung nicht deutlich anders angegeben haben, sind alle
                        von uns angebotenen Artikel sofort versandfertig. Die Lieferung erfolgt hier spätesten innerhalb
                        von 1 Werktagen. Dabei beginnt die Frist für die Lieferung im Falle der Zahlung per Vorkasse am
                    ...
                    <p/>
                    <p>(2) Die Gefahr des zufälligen Untergangs und der zufälligen Verschlechterung der verkauften Sache
                    ...
                    <p>mittels einer eindeutigen Erklärung (z.B. ein mit der Post versandter Brief, Telefax oder E-Mail)
                    ...
                    <p/>
                    <p>Haben Sie verlangt, dass die Dienstleistungen während der Widerrufsfrist beginnen soll, so haben
